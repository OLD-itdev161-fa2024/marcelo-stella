...
const Register = ({authenticateUser}) => {
    ...
    return(
        <div>
            ...
            <div>
                <input type='text' placeholder='Password' name='password' value={password} onChange={e => onChange(e)}></input>
            </div>
            <div>
                <input type='text' placeholder='Confirm Password' name='passwordConfirm' value={passwordConfirm} onChange={e => onChange(e)}></input>
            </div>
            <div>
